            ...
            <div className='pl-10 pb-10'>
                ...
                {textTabVisible && (
                    <div className='h-screen'>
                        <textarea className='overscroll-none w-1/2 h-1/2 border-2 border-gray-700 text-2xl drop-shadow-xl md:resize max-h-full rounded-b-lg rounded-r-md' maxLength="50000" value={textData} onChange={onTextChange}></textarea>
